...
# =^..^= Proxied library: https://raw.githubusercontent.com/ToXic2290/Hikka-moduless/main/GameCheatsLib.py -> https://heta.hikariatama.ru/libs/shino_NUNUZwkfYgiJLPMrEJou.py
...
class GameeCheatMod(loader.Module):
    ...
    strings = {
        "name": "GameeCheats",
        "result": (
            "<emoji document_id=6334592388073260525>🪄</emoji> <b>Рекорд"
            " накручен</b>!\n<emoji document_id=6334649330749671032>✨</emoji> Новый"
            " рекорд: <code>{}</code>"
        ),
        "err_args": (
            "<emoji document_id=6334664779747034990>🚫</emoji> <b>Введите нужные"
            " аргументы</b>!\n<emoji document_id=6334638004920911460>ℹ️</emoji> Пример:"
            " <code>{}chg <ссылка> <рекорд></code>"
        ),
        "banned": (
            "<emoji document_id=6334363088359262569>⛔️</emoji> <b>Вы были заблокированы"
            " в боте</b>!\n<emoji document_id=6334638004920911460>ℹ️</emoji> <code>Вы"
            " не можете ставить новые рекорды в течении 24 часов</code>"
        ),
        "banned_perm": (
            "<emoji document_id=6334363088359262569>⛔️</emoji> <b>Вы были заблокированы"
            " в боте навсегда</b>!\n<emoji document_id=6334638004920911460>ℹ️</emoji>"
            " <code>Вы не можете ставить новые рекорды в @gamee</code>"
        ),
        "error_link": (
            "<emoji document_id=6334664779747034990>🚫</emoji> <b>Вы ввели неправильную"
            " ссылку</b>!\n<emoji document_id=6334638004920911460>ℹ️</emoji>"
            " <code>Введите правильную ссылку или же посмотрите</code> <a"
            ' href="https://t.me/help_code/15">туториал</a>'
        ),
    }
    ...
    async def chg(self, message: Message):
        ...
        if not args:
            await utils.answer(
                message, self.strings("err_args").format(self.get_prefix())
            )
        ...
        result = await self.lib.send_score(
            score, time, checksum, token, game_url, Game_number
        )
